 ...
 *
 * Disassembly of SSDT-2-86C8.aml, Tue Jun 16 23:52:29 2020
 *
 ...
 */
DefinitionBlock ("", "SSDT", 2, "HPQOEM", "86C8    ", 0x00003000)
{
    External (_SB_.PCI0, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.B0D3, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.GFX0, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.CPSC, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.DSEN, UnknownObj)    // (from opcode)
    ...
    External (_SB_.PCI0.GFX0.OSYS, IntObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.PCHN, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.PCHS, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.S0ID, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.IMMC, MethodObj)    // 5 Arguments (from opcode)
    ...
    OperationRegion (SANV, SystemMemory, 0x71DF1098, 0x01F4)
    ...
    Scope (\_SB.PCI0.GFX0)
    {
        ...
        Device (DD01)
        {
            ...
            {
                If (LAnd (LEqual (And (HGMD, 0x7F), One), CondRefOf (SNXD)))
                {
                    Return (NXD1)
                }
        ...
        Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
        {
            ...
            {
                If (LAnd (LEqual (PCHS, PCHN), LOr (LEqual (Arg2, 0x12), LEqual (Arg2, 0x13))))
                {
                ...
                Switch (ToInteger (Arg2))
                {
                    ...
                    Case (0x12)
                    {
                        Store (\_SB.PCI0.IMMC (0x03, 0x03E8, DDIN, Zero, Zero), OPTS)
                        Store (CMST, GESF)
                        Store (RTB1, GEDF)
                        Return (GEDB)
                    }
                    Case (0x13)
                    {
                        Store (\_SB.PCI0.IMMC (0x06, 0x03E8, DDIN, Zero, BUF1), OPTS)
                        Store (CMST, GESF)
                        Store (RTB1, GEDF)
                        Return (GEDB)
                    }
