 ...
 *
 * Disassembly of SSDT-1-86C8.aml, Tue Jun 16 23:52:29 2020
 *
...
DefinitionBlock ("", "SSDT", 2, "HPQOEM", "86C8    ", 0x00003000)
{
    ...
    {
        Name (CTPC, Zero)
        OperationRegion (PNVS, SystemMemory, 0x6C7E3000, 0x005D)
    ...
    Scope (\_SB.PR01)
    {
        ...
        {
            If (LAnd (And (CFGD, 0x72), LNot (And (SDTL, 0x20))))
            {
                Or (SDTL, 0x20, SDTL)
